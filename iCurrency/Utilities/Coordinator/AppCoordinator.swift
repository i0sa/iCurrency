...
class AppCoordinator: Coordinator {
    ...
    // MARK: Functions
    func start() {
        guard let mainViewController = Main?.viewController(for: .CurrencyConvertor(selectedCurrency: Currency(currency: "USD", value: 1), base: Currency(currency: "EUR", value: 1)), with: self) else { return }
